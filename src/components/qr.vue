  ...
  <div class="am-g-collapse">
    ...
    <div class="am-u-sm-12">
      <div style="margin-top: 40px">
        <div class="tip" style="float: left;width: 100%;height: 30px"> <span><img src="../assets/i/tip.png" width="16" alt="" style="z-index: 999;background-color: white"><label
  ...
  export default {
    ...
    mounted: function () {
      this.$nextTick(function () {
        ...
        qrg.addData(qr);
        qrg.make();
        document.getElementById("qrcode").innerHTML = qrg.createImgTag(4);
